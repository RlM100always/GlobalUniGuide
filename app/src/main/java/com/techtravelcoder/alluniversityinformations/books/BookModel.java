...
public class BookModel {
    ...
    String bookCategoryName,bookKeyWord,bookCategoryKeyWord;
    String bookPostDate;
    String bookMbSize,bookPageNo,bookCategoryType,bookPriceType,bookLanguageType;
    Map<String, Bookmark> bookmarkbook;
    ...
    public Map<String, Bookmark> getBookmarkbook() {
        return bookmarkbook;
    }

    public void setBookmarkbook(Map<String, Bookmark> bookmarkbook) {
        this.bookmarkbook = bookmarkbook;
    }
